...
let CrudResponseInterceptor = class CrudResponseInterceptor extends crud_base_interceptor_1.CrudBaseInterceptor {
    ...
    transform(dto, data, options) {
        if (!crud_util_1.isObject(data) || crud_util_1.isFalse(dto)) {
            return data;
        }
        if (!crud_util_1.isFunction(dto)) {
            return data.constructor !== Object ? class_transformer_1.classToPlain(data, options) : data;
        }
        return data instanceof dto
            ? class_transformer_1.classToPlain(data, options)
            : class_transformer_1.classToPlain(class_transformer_1.classToPlainFromExist(data, new dto()), options);
    }
    serialize(context, data) {
        ...
        const options = {};
        if (crud_util_1.isFunction((_a = crudOptions.auth) === null || _a === void 0 ? void 0 : _a.classTransformOptions)) {
        ...
        if (crud_util_1.isFunction((_b = crudOptions.auth) === null || _b === void 0 ? void 0 : _b.groups)) {
            const userOrRequest = crudOptions.auth.property
                ? req[crudOptions.auth.property]
                : req;
